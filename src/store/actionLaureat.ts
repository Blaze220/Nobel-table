...
export const fetchGetLaureates = createAsyncThunk(
    "laureates/fetchGetLaureates",
    async(payload:number=40,{ rejectWithValue })=>{
        try{
            let response = await fetch(`${API_URL}/laureates?limit=${payload}&sort=asc`)
